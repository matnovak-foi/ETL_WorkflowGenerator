 ...
 */
public class ETLGen2AgregatorAndCE extends RouteBuilder {

    @Override
    public void configure() throws Exception {
        from("file:target/gen2/ADD FROM?noop=false")
                    ...
                    public Exchange aggregate(Exchange exchng, Exchange exchng1) {
                        ...
                        try {
                            if (exchng == null) {
                                ...
                                dest_name.setTextContent("ADD DEST NAME");
                                ...
                                att_name.setTextContent("ADD ATT NAME");
                                ...
                                String trans_name = "ADD TRANS NAME";
                ...
                .completionSize(2)//ADD QUEUE SIZE
                .to("file:target/gen3/input?fileName=ADD XML FILE NAME");
    }
