 ...
 */
public class ETLGen2AgregatorAndCEsource_1_Street_Number_City extends RouteBuilder {

    @Override
    public void configure() throws Exception {
        from("file:target/gen2/source_1Street_Number_City?noop=false")
                ...
                .completionSize(3)
                .to("file:target/gen3/input?fileName=message-9_source_1_gen2.xml");
    }
