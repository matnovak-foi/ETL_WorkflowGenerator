 ...
 */
public class ETLGen2AgregatorAndCEsource_2_Street_Number_City extends RouteBuilder {

    @Override
    public void configure() throws Exception {
        from("file:target/gen2/source_2Street_Number_City?noop=false")
                    ...
                    public Exchange aggregate(Exchange exchng, Exchange exchng1) {
                        ...
                        try {
                            if (exchng == null) {
                                ...
                                att_name.setTextContent("Street_Number_City");
                ...
                .completionSize(3)
                .to("file:target/gen3/input?fileName=message-16_source_2_gen2.xml");
    }
