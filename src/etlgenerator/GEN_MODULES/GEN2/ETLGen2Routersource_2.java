 ...
 */
public class ETLGen2Routersource_2 extends RouteBuilder{

    @Override
    public void configure() throws Exception {
         System.out.println("Configuring GEN2_router"+this.getClass().getName());
         
         from("file:target/gen2/gen2_source_2?noop=false").
            choice()
            
.when(xpath("/message/source/attribute = 'Name'"))
.to("file:target/gen2/source_2Name_Surname")
.otherwise()
...
.to("file:target/gen2/source_2Street_Number_City")
.otherwise()
