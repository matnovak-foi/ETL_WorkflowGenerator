 ...
 */
public class ETLGen2AgregatorAndCEsource_1_Name_Surname extends RouteBuilder {

    @Override
    public void configure() throws Exception {
        from("file:target/gen2/source_1Name_Surname?noop=false")
                ...
                .completionSize(2)
                .to("file:target/gen3/input?fileName=message-5_source_1_gen2.xml");
    }
